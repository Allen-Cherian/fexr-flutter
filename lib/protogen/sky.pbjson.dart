...
const ChallengeReq$json = const {
  '1': 'ChallengeReq',
  '2': const [
    const {'1': 'purpose', '3': 1, '4': 1, '5': 14, '6': '.protos.ChallengeReq.purposeType', '9': 0, '10': 'purpose', '17': true},
    const {'1': 'sender', '3': 2, '4': 1, '5': 9, '10': 'sender'},
    const {'1': 'challengeBody', '3': 3, '4': 1, '5': 9, '10': 'challengeBody'},
    const {'1': 'issuedAt', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 1, '10': 'issuedAt', '17': true},
  ],
...
final $typed_data.Uint8List challengeReqDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use strNumResDescriptor instead')
const StrNumRes$json = const {
  '1': 'StrNumRes',
  '2': const [
    const {'1': 'message', '3': 1, '4': 1, '5': 9, '10': 'message'},
  ],
...
/// Descriptor for `StrNumRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List strNumResDescriptor = $convert.base64Decode('CglTdHJOdW1SZXMSGAoHbWVzc2FnZRgBIAEoCVIHbWVzc2FnZQ==');
