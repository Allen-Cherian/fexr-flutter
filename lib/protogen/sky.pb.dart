...
class ChallengeReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChallengeReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'challengeBody', protoName: 'challengeBody')
    ..aOM<$2.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuedAt', protoName: 'issuedAt', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ChallengeReq({
    ...
    if (challengeBody != null) {
      _result.challengeBody = challengeBody;
    }
    if (issuedAt != null) {
  ...
  @$pb.TagNumber(3)
  $core.String get challengeBody => $_getSZ(2);
  @$pb.TagNumber(3)
  set challengeBody($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasChallengeBody() => $_has(2);
  @$pb.TagNumber(3)
  void clearChallengeBody() => clearField(3);

  @$pb.TagNumber(4)
  $2.Timestamp get issuedAt => $_getN(3);
  @$pb.TagNumber(4)
  set issuedAt($2.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasIssuedAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearIssuedAt() => clearField(4);
  @$pb.TagNumber(4)
  $2.Timestamp ensureIssuedAt() => $_ensure(3);
}
...
class StrNumRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StrNumRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message')
    ..hasRequiredFields = false
  ;
  ...
  factory StrNumRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StrNumRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  StrNumRes clone() => StrNumRes()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StrNumRes copyWith(void Function(StrNumRes) updates) => super.copyWith((message) => updates(message as StrNumRes)) as StrNumRes; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StrNumRes create() => StrNumRes._();
  StrNumRes createEmptyInstance() => create();
  static $pb.PbList<StrNumRes> createRepeated() => $pb.PbList<StrNumRes>();
  @$core.pragma('dart2js:noInline')
  static StrNumRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StrNumRes>(create);
  static StrNumRes? _defaultInstance;
